				...
				<ul class="top_nav nav justify-content-center">
					  ...
					  <li class="nav-item dropdown">
					        ...
					        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
					          ...
					          <a class="dropdown-item" href="#">Películas de Westerns</a>
			...
			<div class="main mt-5">
				...
				<div class="card-deck mb-5">
					  ...
					  <div class="tarjeta card">
					    ...
					    <div class="card-body">
					      <h4 class="h4_categoria">Acción y Aventuras</h4>
					      <hr>
					    </div>
					  ...
					  <div class="tarjeta card">
					    ...
					    <div class="card-body">
					      <h4 class="h4_categoria">Ciencia Ficción</h4>
					      <hr>
					    </div>
					  ...
					  <div class="tarjeta card">
					    ...
					    <div class="card-body">
					      <h4 class="h4_categoria">Westerns</h4>
					      <hr>
					    </div>
					    <a href="#" class="boton btn text-center btn-sm text-white">Continuar <i class="fas fa-angle-double-right"></i></a>
					  </div>
					  ...
					  <div class="tarjeta card">
					    ...
					    <div class="card-body">
					      <h4 class="h4_categoria">Terror</h4>
					      <hr>
					    </div>
					    <a href="#" class="boton btn text-center btn-sm text-white">Continuar <i class="fas fa-angle-double-right"></i></a>
					  </div>
